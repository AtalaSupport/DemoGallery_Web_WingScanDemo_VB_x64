...
/**
   ...
   */function Z(e,t,n){var o={};e.multiview?o=e:(e&&e.type&&b[e.type]&&pn.extend(!0,o,b[e.type]),pn.extend(!0,o,e));var i=new Oe(d,o,m);i._pageindex=t,i.setFIndex(t);var a=i.get().annotationId;return a&&0!==a&&!de(a)||(a=le()+1,i.setAnnotationId(a)),m.maxAnnotationId<a&&(m.maxAnnotationId=a),void 0===m.annos[t]&&(m.annos[t]=[]),m.annos[t].push(i),ce(a),x.redrawPageFromIndex(t,!0),"function"==typeof n&&n(i),_e(i),d.trigger({type:w.annocreate,anno:i,annotation:i,page:t}),i}function X(e,t,n){return Z(e,t,n).getClonedData()}function G(e,t){Y(t,e)}
/**
   ...
   */function Y(e,t){var n=m.annos[t].splice(e,1)[0],o=n.get();o&&ue(o.annotationId),m.activepage&&m.activepage._paper&&m.activepage._paper._annos.exclude(n.getObject()),m.activeanno===n&&(m.activeanno=null),n.dispose(),m.activepage&&m.activepage._grips&&m.activepage._grips.repaint(),d.trigger({type:"annotationdeleted",page:t,index:e})}function J(e){var n=this,t=[];if(0===m.annos.length||void 0===m.annos[e])return t;for(var o=0;o<m.annos[e].length;o++)t[o]=m.annos[e][o].getClonedData();return t.sort(function(e,t){return Re(this,n),e.tabindex-t.tabindex}.bind(this))}function Q(e,t){if(isFinite(t)){if(t<m.annos.length)for(var n=0;n<m.annos[t].length;++n)if(m.annos[t][n].isCloneSource(e))return m.annos[t][n]}else for(var o=0;o<m.annos.length;++o){var i=Q(e,o);if(i)return i}return null}function K(e){l.annotations.defaults=e;for(var t=0;t<e.length;t++)"string"==typeof e[t].type&&(b[e[t].type]=e[t]);return d}function $(e){l.annotations.stamps=e;for(var t=0;t<e.length;t++)Ie(e[t]);if(u){var n={type:"button",id:x._id+"_toolbar_Button_Stamp",icon:"stamp",tooltip:"Draw Stamp",text:""},o=x.createDropDownButton(n);n.onclick=x.drawAnnotation,x.createDropDownMenu(o,n,e)}return d}function ee(e){l.annotations.images=e;for(var t=0;t<e.length;t++)e[t].type="image";if(u){var n={type:"button",id:x._id+"_toolbar_Button_Image",icon:"image",tooltip:"Draw Image",text:""},o=x.createDropDownButton(n);n.onclick=x.drawAnnotation,x.createDropDownMenu(o,n,e)}return d}
/**
...
/**
   ...
   */
a.__getDebugInfo=function(){var e={};return pn.extend(!0,e,{data:m,defaults:b,drawing:y,drawready:_,matrix:v,menu:f,menuconfig:g,pages:s,props:p,viewport:h}),e}
/**
